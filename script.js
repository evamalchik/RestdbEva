...
let url = '"https://market-dc23.restdb.io/rest';

xhr.open('GET', url + '/products');
xhr.open("GET", "https://market-dc23.restdb.io/rest/products");
xhr.setRequestHeader("content-type", "application/json");
xhr.setRequestHeader("x-apikey", "680e1f9972702c486cb3d318	");
...
xhr.open("POST", "https://market-dc23.restdb.io/rest/orders");
xhr.setRequestHeader("content-type", "application/json");
xhr.setRequestHeader("x-apikey", "680e1f9972702c486cb3d318");
xhr.setRequestHeader("cache-control", "no-cache");
